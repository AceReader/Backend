"""
Output:
    - 3 models (.joblib) : NB, SVM, CRF
    - 2 txt (.txt) : selected_bigrams, selected_unigrams
"""
...
from preprocess_PUBMED import readData_PUBMED,content_features,location_feature
...
# Save selected grams for saving models
